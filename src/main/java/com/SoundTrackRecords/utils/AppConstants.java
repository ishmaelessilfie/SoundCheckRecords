...
public class AppConstants {
        public static final String USERUPDATE_URI ="updateprofile";
	public static final String USER_URI = "/profile";
	public static final String USER_JSON_PARAM = "empJson";
        public static final String USER_PASS="password";
	public static final String USER_FILE_PARAM = "file";
        public static final String USER_FILEHIDDEN_PARAM = "filehidden";
...
//	public static final String TEMP_DIR = "Documents:\\uploads";C:\temp
        public static final String TEMP_DIR = "C:\\temp\\uploads";
